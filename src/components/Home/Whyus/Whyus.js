...
const Whyus = () => {
    ...
    return (
        ...
        <Box sx={{ bgcolor: '#4f5692', color: 'white', p: 2, mb: 2, textAlign: "center" }}>
            <Container maxWidth="xl">
                ...
                <Typography sx={{ mb: 8, fontWeight: 600 }}
                    variant='h5'
                >Expert care, faster recovery, lasting relief.
                </Typography>
                                    ...
                                    <Card sx={{
                                        ...
                                        <CardActions style={{justifyContent: 'center'}}>
                                            <Typography sx={{ mx: 2, p: 2, textAlign: "end" }} >
                                                <Link className='text-style' to="/services" color="#4f5692">
                                                    See More Details...
                                                </Link>
                                            </Typography>
                                        </CardActions>
